<template>
  <main class="m-20">
    <div>
      <div class="z-0 lg:grid lg:w-80 lg:p-4">
        <div class=""><h1 class="font-gravitasOne text-xl">Configurateur de produit pour une montre connectée</h1></div>
      </div>

      <div class="lg:grid lg:grid-cols-3">
        <div class="lg:grid lg:items-end lg:text-enorme">
          <div>
            <p class="TT text-benimki2">Tik・Tak</p>
            <p class="TT text-benimki2 lg:-mt-16 lg:ml-16">Tik・Tak</p>
          </div>
        </div>
        <div class="lg:grid lg:items-center lg:justify-items-center">
          <img src="../assets/projet1/images/montre.png" alt="image d'une montre de la marque Tik ● Tak" />
        </div>
        <div class="lg:grid lg:items-start lg:text-enorme">
          <div>
            <p class="TT text-benimki2">Tik・Tak</p>
            <p class="TT text-benimki2 lg:-mt-16 lg:ml-16">Tik・Tak</p>
          </div>
      ...
      <div class="lg:mt-16 lg:grid lg:justify-center">
        <img src="../assets/logo/menuPage.svg" alt="" />
      </div>
    </div>
    ...
    <div class="lg:mt-20 lg:flex lg:items-center lg:justify-evenly">
      <div class="lg:w-72">
        <h2 class="">context</h2>
        <p class="mt-4">
          Creation of a product configurator for the TiK●TiK connected watch. The aim was to involve the user in the creation of their model
          and offer them a unique user experience.
        </p>
      </div>
      <img src="../assets/projet1/logoTikTak.svg" alt="" />
    </div>
    ...
    <div>
          ...
          <div>
            ...
            <div class="lg:flex">
              ...
              <p class="lg:ml-10 lg:w-96">
                ...
                modified the svg of the watch provided before in order to have a shape and a style that better suited my study. From there,
                I was able to create the brandboard and the visual identity of the project (watch + site). From then on, I was able to start
                the design of the website model on Figma.
              </p>
            </div>
          </div>
      ...
      <div class="lg:mt-20 lg:grid">
        <div class="lg:flex lg:items-center">
          ...
          <p class="lg:ml-10 lg:w-96">
            In the <strong class="font-iceberg">second</strong> phase, I carried out a marketing nudge study, including SMART objectives,
            and the cognitive biases of this study.
          </p>
        </div>
      </div>
    ...
    <div>
      <div class="lg:mt-20 lg:grid">
        <div class="lg:flex lg:items-center">
          ...
          <p class="lg:ml-10 lg:w-96">
            So, in the <strong class="font-iceberg">third</strong> and last phase I developed my website with the Tailwind CSS Framework.
            And I ended up putting it online on heroku.
          </p>
        </div>
      </div>
      ...
      <div class="lg:mt-20">
        <h2 class="flex lg:justify-center">tools</h2>
        <div class="flex lg:mt-4 lg:h-12 lg:justify-evenly">
          <img src="@/assets/logo/dev/VSC.png" alt="logo Visual Studio Code" />
          <img src="@/assets/logo/dev/TailwindCSS.png" alt="logo Tailwin CSS" />
          <img src="@/assets/logo/dev/VueJS.png" alt="logo VueJS" />
          <img src="../assets/logo/dev/Heroku.png" alt="logo Heroku" />
          <img src="@/assets/logo/dev/Netlify.png" alt="logo Netlify" />
          <img src="@/assets/logo/dev/Github.png" alt="logo Github" />
        </div>
      </div>
    </div>
