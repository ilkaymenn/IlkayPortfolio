    ...
    <div>
      ...
      <div class="lg:mt-20 lg:flex lg:items-center lg:justify-evenly">
        <div class="lg:w-72">
          <h2 class="">context</h2>
          <p class="mt-4">
            Creation of a product configurator for the TiK●TiK connected watch. The aim was to involve the user in the creation of their
            model and offer them a unique user experience.
          </p>
        </div>
            ...
            <div>
              ...
              <div class="lg:flex">
                ...
                <p class="lg:ml-10 lg:w-96">
                  ...
                  modified the svg of the watch provided before in order to have a shape and a style that better suited my study. From
                  there, I was able to create the brandboard and the visual identity of the project (watch + site). From then on, I was able
                  to start the design of the website model on Figma.
                </p>
              </div>
            </div>
